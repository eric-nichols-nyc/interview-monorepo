 ...
 */
export async function getProfileAction(): Promise<ActionResult<Profile | null>> {
  try {
 ...
 */
export async function updateProfileAction(formData: ProfileFormData): Promise<ActionResult<Profile>> {
  try {
    const userId = await getCurrentUserId();
 ...
 */
export async function validateProfileAction(formData: ProfileFormData): Promise<ActionResult<boolean>> {
  try {
    const validationResult = profileSchema.safeParse(formData);
