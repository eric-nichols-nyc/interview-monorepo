...
import { getProfileAction, updateProfileAction, ActionResult } from './profile-actions';
...
export function useUpdateProfile() {
  ...
  return useMutation({
    ...
    onMutate: async (newProfile: ProfileFormData) => {
      ...
      queryClient.setQueryData(profileKeys.current(), (old: ActionResult<Profile | null> | undefined) => {
...
export function useCachedProfile() {
  ...
  const cachedData = queryClient.getQueryData(profileKeys.current()) as ActionResult<Profile | null> | undefined;
